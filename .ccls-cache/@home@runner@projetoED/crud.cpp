...
// vizualiza registro em um dado intervalo
void vizualizarRegistros(fstream &arquivo, int inicio, int fim) {
  Atleta atletaAux;
  ...
  if (arquivo) {
    ...
    while (opcao != 6) {
      ...
      case 2:
        ...
        cout << "OBS: escolha os valores entre 0 e " << tamanhoDoArq-2 << endl;
        ...
        cout << endl << endl;
        vizualizarRegistros(arquivo, inicio, fim);
      ...
      case 5:
        ...
        vizualizarRegistros(arquivo, 0, tamanhoDoArq-2);
